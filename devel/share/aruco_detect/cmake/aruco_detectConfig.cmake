...
if("TRUE" STREQUAL "TRUE")
  set(aruco_detect_SOURCE_PREFIX /home/vyshnav/ERC-Maintenance-Stack/src/packages/aruco_detect)
  set(aruco_detect_DEVEL_PREFIX /home/vyshnav/ERC-Maintenance-Stack/devel)
  ...
  set(aruco_detect_INSTALL_PREFIX /home/vyshnav/ERC-Maintenance-Stack/install)
...
if(NOT "/home/vyshnav/ERC-Maintenance-Stack/devel/include;/usr/include/opencv4 " STREQUAL " ")
  set(aruco_detect_INCLUDE_DIRS "")
  set(_include_dirs "/home/vyshnav/ERC-Maintenance-Stack/devel/include;/usr/include/opencv4")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'aruco_detect' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/vyshnav/ERC-Maintenance-Stack/src/packages/aruco_detect/${idir}'.  ${_report}")
    endif()
...
foreach(depend ${depends})
  ...
  _list_append_deduplicate(aruco_detect_EXPORTED_TARGETS ${${aruco_detect_dep}_EXPORTED_TARGETS})
endforeach()
