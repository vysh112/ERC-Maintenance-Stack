...
struct FiducialArray_
{
  ...
  _image_seq_type image_seq;
   ...
   typedef std::vector< ::fiducial_msgs::Fiducial_<ContainerAllocator> , typename std::allocator_traits<ContainerAllocator>::template rebind_alloc< ::fiducial_msgs::Fiducial_<ContainerAllocator> >> _fiducials_type;
