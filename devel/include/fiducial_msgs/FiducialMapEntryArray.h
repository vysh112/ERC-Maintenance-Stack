...
struct FiducialMapEntryArray_
{
  ...
  (void)_alloc;
   ...
   typedef std::vector< ::fiducial_msgs::FiducialMapEntry_<ContainerAllocator> , typename std::allocator_traits<ContainerAllocator>::template rebind_alloc< ::fiducial_msgs::FiducialMapEntry_<ContainerAllocator> >> _fiducials_type;
