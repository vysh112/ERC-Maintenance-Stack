...
struct FiducialTransformArray_
{
  ...
  _image_seq_type image_seq;
   ...
   typedef std::vector< ::fiducial_msgs::FiducialTransform_<ContainerAllocator> , typename std::allocator_traits<ContainerAllocator>::template rebind_alloc< ::fiducial_msgs::FiducialTransform_<ContainerAllocator> >> _transforms_type;
...
bool operator==(const ::fiducial_msgs::FiducialTransformArray_<ContainerAllocator1> & lhs, const ::fiducial_msgs::FiducialTransformArray_<ContainerAllocator2> & rhs)
{
