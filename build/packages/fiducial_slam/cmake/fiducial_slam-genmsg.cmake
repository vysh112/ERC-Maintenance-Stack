...
get_filename_component(_filename "/home/vyshnav/ERC-Maintenance-Stack/src/packages/fiducial_slam/srv/AddFiducial.srv" NAME_WE)
add_custom_target(_fiducial_slam_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "fiducial_slam" "/home/vyshnav/ERC-Maintenance-Stack/src/packages/fiducial_slam/srv/AddFiducial.srv" ""
)
...
_generate_srv_cpp(fiducial_slam
  "/home/vyshnav/ERC-Maintenance-Stack/src/packages/fiducial_slam/srv/AddFiducial.srv"
  "${MSG_I_FLAGS}"
  ""
...
if(genpy_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/fiducial_slam)
  install(CODE "execute_process(COMMAND \"/usr/bin/python3\" -m compileall \"${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/fiducial_slam\")")
  # install generated code
  install(
